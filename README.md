...
## 📁 Featured Projects
🚀 **[My Coding Journey](https://execuassistbytr-rgb.github.io/my-coding-journey/))** — My absolute favorite project! A dynamic, premium neon dark-mode interface built to showcase structural frontend engineering, advanced CSS transitions, and complex interactive JavaScript prompt validation networks. 
🥛 **[Greek Yogurt Landing Page](https://execuassistbytr-rgb.github.io/greek-yogurt-landing-page/))** — A warm, beautifully balanced product page exploring multi-column structural grids, strict image alignment boundaries, and operational logic paths.
